...
export default function ACCMenSearch({ changeTeam }) {
  ...
  const filterOptions = [
    ...
    { value: "https://www.tfrrs.org/teams/xc/SC_college_m_Clemson.html", label: 'Clemson' },
    { value: "https://www.tfrrs.org/teams/xc/NC_college_m_Duke.html", label: 'Duke' },
    { value: "https://www.tfrrs.org/teams/xc/FL_college_m_Florida_State.html", label: 'Florida State' },
    { value: "https://www.tfrrs.org/teams/xc/GA_college_m_Georgia_Tech.html", label: 'Georgia Tech' },
    ...
    { value: "https://www.tfrrs.org/teams/xc/NC_college_m_North_Carolina_St.html", label: 'NC State' },
